function ThemeManager(options) {
    ...
    var enableAutoDetectTheme = options.enableAutoDetectTheme.toLowerCase() === 'true';  // true

    var darkThemeMatch = window.matchMedia(  // { matches: true, ...}
        defaultTheme === 'light' ?
    ...
    function detectThemeAndSwitchStyle() {
        ...
        // setEnabledAndDisableMediaQuery('light-theme-style', theme === 'light');
